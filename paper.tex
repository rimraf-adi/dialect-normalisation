...
\textbf{Dataset Partition} & \textbf{Total Size} & \textbf{Test Size} & \textbf{IndicBART BLEU} & \textbf{mT5-Small BLEU} & \textbf{$\Delta$ BLEU} & \textbf{IndicBART chrF++} & \textbf{mT5-Small chrF++} & \textbf{$\Delta$ chrF++} \\
\midrule
\textbf{D1 (Malvani)} & 11,145 & 1,671 & 38.91 & \textbf{54.84} & \textbf{+15.93} & 59.11 & \textbf{76.17} & \textbf{+17.06} \\
\textbf{D2 (Ahirani)} & 11,035 & 1,655 & 33.68 & \textbf{54.83} & \textbf{+21.15} & 54.12 & \textbf{75.89} & \textbf{+21.77} \\
\textbf{D4 (Varhadi)} & 10,155 & 1,523 & 50.15 & \textbf{58.70} & \textbf{+8.55} & 69.80 & \textbf{79.12} & \textbf{+9.32} \\
\midrule
\textbf{D124 Combined} & 32,335 & 4,850 & 63.59 & \textbf{69.05} & \textbf{+5.46} & 80.12 & \textbf{84.36} & \textbf{+4.24} \\
\bottomrule
\end{tabularx}
\end{table*}
