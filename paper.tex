...
\midrule
\textbf{D1 (Malvani)} & 5,576 & 836 & 48.52 & \textbf{46.31} & -2.21 & 78.49 & \textbf{74.43} & -4.06 \\
\textbf{D2 (Ahirani)} & 5,501 & 825 & 47.29 & \textbf{60.31} & \textbf{+13.02} & 66.84 & \textbf{77.34} & \textbf{+10.50} \\
\textbf{D4 (Varhadi)} & 5,086 & 762 & 72.87 & \textbf{80.99} & \textbf{+8.12} & 85.72 & \textbf{91.21} & \textbf{+5.49} \\
\midrule
...
\begin{table*}[t]
\caption{Benchmark Performance Matrix on 32k Expanded Datasets (32,335 Parallel Pairs)}
...
\textbf{Dataset Partition} & \textbf{Total Size} & \textbf{Test Size} & \textbf{IndicBART BLEU} & \textbf{mT5-Small BLEU} & \textbf{$\Delta$ BLEU} & \textbf{IndicBART chrF++} & \textbf{mT5-Small chrF++} & \textbf{$\Delta$ chrF++} \\
\midrule
\textbf{D1 (Malvani)} & 11,145 & 1,671 & 47.25 & \textbf{65.10} & \textbf{+17.85} & 64.69 & \textbf{82.88} & \textbf{+18.19} \\
\textbf{D2 (Ahirani)} & 11,035 & 1,655 & 40.51 & \textbf{62.07} & \textbf{+21.56} & 62.21 & \textbf{79.29} & \textbf{+17.08} \\
\textbf{D4 (Varhadi)} & 10,155 & 1,523 & 73.62 & \textbf{78.89} & \textbf{+5.27} & 86.75 & \textbf{90.59} & \textbf{+3.84} \\
\midrule
\textbf{D124 Combined} & 32,335 & 4,850 & 57.12 & \textbf{69.51} & \textbf{+12.39} & 75.49 & \textbf{84.58} & \textbf{+9.09} \\
\bottomrule
\end{tabularx}
\end{table*}
