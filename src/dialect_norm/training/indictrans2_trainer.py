...
class IndicTrans2DialectDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if hasattr(self.tokenizer, "tgt_lang"):
            self.tokenizer.tgt_lang = "mar_Deva"
...
def run_cross_validation_indictrans2(
    ...
    if hasattr(tokenizer, "tgt_lang"):
        tokenizer.tgt_lang = "mar_Deva"

    # 3. Create Test Dataset
    test_dataset = IndicTrans2DialectDataset(test_data, tokenizer)
    ...
    for fold in range(n_folds):
        logger.info(f"\n======================================================================")
        logger.info(f"RUNNING IndicTrans2 CROSS-VALIDATION: FOLD {fold + 1}/{n_folds}")
        logger.info(f"======================================================================")
